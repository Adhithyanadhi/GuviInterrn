...
<html>
    ...
    <body class="bg" >
        <section class="container-fluid cnt ">
          <button class="trans back"><a href="login.html">Back</a></button>
                ...
                <section class="col-sm-5 col-md-4 col-lg-3 col-9 mar_btm" >
                    <fieldset class="form-container">
                       ...
                       <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input  type="text" id="name" name="name"  value='<?php echo $row["username"]; ?>' class="form-control-plaintext" disabled="true">
                         </div></div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="email">Email-&nbspID&nbsp:</label>
                            <div class="col-sm-10">
                                <input  type="text" name="email" id="email"  value='<?php echo $row["email"]; ?>' class="form-control-plaintext" disabled="true" >
                         </div></div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="contact">Contact Number&nbsp:</label>
                            <div class="col-sm-10">
                                <input  type="text" name="contact" id="contact"  value='<?php echo $row["contact"]; ?>' class="form-control-plaintext" disabled="true">
                         </div></div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="dob">DOB&nbsp:</label>
                            <div class="col-sm-10">
                                <input  type="date" name="dob" id="dob"  value='<?php echo $row["dob"]; ?>' class="form-control-plaintext" disabled="true">
                         </div></div>
                         <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="age">Your&nbspage&nbsp:</label>
                            <div class="col-sm-10">
                                <input  type="text" id="age" name="age"  value='<?php echo $row["age"]; ?>' class="form-control-plaintext" disabled="true">
                         </div></div>

                      <button type="submit" id ="edit" value="<?php echo $name?>"  class="form-group btn btn-block login_btn brdr">EDIT</button>
                    </fieldset>
                </section>
                <section class="col-sm-5 col-md-4 col-lg-3 col-9 mar_btm" >
                    <div class="form-group">
                      <legend class="w-auto cntr">ABOUT&nbspYOURSELF</legend>
                         <div class="col-sm-10 resze">
                            <textarea class="form-control" id="abt"  rows="9" disabled="true"> <?php echo $row['abt']; ?></textarea>
                        </div>
                    </div>
                      <button type="submit"  id ="abt_edit" class=" form-group btn  btn-block login_btn brdr">EDIT</button>
                      <button type="submit"  id ="abt_update" class=" form-group  btn   btn-block login_btn brdr">UPDATE</button>
<?php
}else{
